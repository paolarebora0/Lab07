...
public class PowerOutageDAO {
	...
	public List<PowerOutageEvent> getPowerOutageEventsList(NercIdMap nercIdMap) {
		
		String sql = "SELECT id,nerc_id, date_event_began, date_event_finished, customers_affected FROM poweroutages";
		
		List<PowerOutageEvent> powerOutageEventsList = new ArrayList<>();
